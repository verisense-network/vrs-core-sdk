...
* To export custom structs or enums, use the `#[export]` attribute above their definition:
...
The ABI JSON file is an array of objects, where each object describes an exported item (struct, enum, or function).
